...
bool TreeBillboardsApp::Initialize()
{
	...
	//Maze
	BuildRenderItems("Box", "bricks", 12.0f, 6.0f, 2.0f, 16.0f, 1.0f, 4.0f);
	BuildRenderItems("Box", "bricks", 12.0f, 6.0f, 2.0f, 16.0f, 1.0f, -4.0f);
	BuildRenderItems("Box", "bricks", 12.0f, 6.0f, 2.0f, 27.0f, 1.0f, 4.0f);
	BuildRenderItems("Box", "bricks", 12.0f, 6.0f, 2.0f, 38.0f, 1.0f, 4.0f);
	BuildRenderItems("Box", "bricks", 12.0f, 6.0f, 2.0f, 27.0f, 1.0f, -16.0f);
	BuildRenderItems("Box", "bricks", 12.0f, 6.0f, 2.0f, 38.0f, 1.0f, -16.0f);
	BuildRenderItems("Box", "bricks", 2.0f, 6.0f, 12.0f, 22.0f, 1.0f, -9.0f);
	BuildRenderItems("Box", "bricks", 2.0f, 6.0f, 12.0f, 30.0f, 1.0f, -2.0f);
	BuildRenderItems("Box", "bricks", 2.0f, 6.0f, 12.0f, 43.0f, 1.0f, -9.0f);
...
void TreeBillboardsApp::BuildShapeGeometry(string name, const GeometryGenerator::MeshData& shape)
{
...
void TreeBillboardsApp::BuildRenderItems(string name, string materials, float sX, float sY, float sZ, float tX, float tY, float tZ)
{
