...
private:
	...
	void BuildShapeGeometry(string name, const GeometryGenerator::MeshData& shape, XMFLOAT4 color);
	void BuildPSOs();

	//step5
	void BuildFrameResources();

	void BuildRenderItems(string name, float sX, float sY, float sZ, float tX, float tY, float tZ);
...
bool ShapesApp::Initialize()
{
	...
	BuildShapeGeometry("Box", geoGen.CreateBox(1.0f, 1.0f, 1.0f, 0), XMFLOAT4(DirectX::Colors::DarkSlateGray));
	BuildShapeGeometry("Box2", geoGen.CreateBox(1.0f, 1.0f, 1.0f, 0), XMFLOAT4(DirectX::Colors::DarkOliveGreen));
	BuildShapeGeometry("Box3", geoGen.CreateBox(1.0f, 1.0f, 1.0f, 0), XMFLOAT4(DirectX::Colors::Black));
	BuildShapeGeometry("Cylinder", geoGen.CreateCylinder(1.0f, 1.0f, 1.0f, 30, 1), XMFLOAT4(DirectX::Colors::DarkMagenta));
	//BuildShapeGeometry("Cone", geoGen.CreateCylinder(1.0f, 0.0f, 1.0f, 30, 1), XMFLOAT4(DirectX::Colors::DarkRed));
	BuildShapeGeometry("Sphere", geoGen.CreateSphere(1.0f, 30, 30), XMFLOAT4(DirectX::Colors::Yellow));
	//BuildShapeGeometry("Triangle", geoGen.CreateSphere(1.0f, 5, 2), XMFLOAT4(DirectX::Colors::Green));
	BuildShapeGeometry("Grid", geoGen.CreateGrid(1.0f, 5.0f, 2, 2), XMFLOAT4(DirectX::Colors::Blue));
	BuildShapeGeometry("Grid2", geoGen.CreateGrid(1.0f, 5.0f, 2, 2), XMFLOAT4(DirectX::Colors::DarkGreen));
	BuildShapeGeometry("Grid3", geoGen.CreateGrid(1.0f, 5.0f, 2, 2), XMFLOAT4(DirectX::Colors::LightSlateGray));

	BuildShapeGeometry("Pyramid", geoGen.CreatePyramid(1.0f, 1.0f, 1.0f, 0), XMFLOAT4(DirectX::Colors::Green));
	BuildShapeGeometry("Cone2", geoGen.CreateCone(1.0f, 1.0f, 10, 2), XMFLOAT4(DirectX::Colors::DarkRed));
	BuildShapeGeometry("Wedge", geoGen.CreateWedge(1.0f, 1.0f, 1.0f, 0), XMFLOAT4(DirectX::Colors::SaddleBrown));
	BuildShapeGeometry("TriangularPrism", geoGen.CreateTriangularPrism(1.0f, 1.0f, 1.0f, 0), XMFLOAT4(DirectX::Colors::DarkGreen));
	BuildShapeGeometry("Diamond", geoGen.CreateDiamond(1.0f), XMFLOAT4(DirectX::Colors::Aquamarine));

	//Alligators
	BuildRenderItems("TriangularPrism", 2.0f, 2.0f, 2.0f, 10.0f, -2.0f, -5.0f);
	BuildRenderItems("TriangularPrism", 2.0f, 2.0f, 2.0f, 10.0f, -2.0f, 5.0f);
	BuildRenderItems("TriangularPrism", 2.0f, 2.0f, 2.0f, 10.0f, -2.0f, -11.0f);
	BuildRenderItems("TriangularPrism", 2.0f, 2.0f, 2.0f, 5.0f, -2.0f, -11.0f);
	BuildRenderItems("TriangularPrism", 2.0f, 2.0f, 2.0f, 0.0f, -2.0f, -11.0f);
	BuildRenderItems("TriangularPrism", 2.0f, 2.0f, 2.0f, -5.0f, -2.0f, -11.0f);
	BuildRenderItems("TriangularPrism", 2.0f, 2.0f, 2.0f, -10.0f, -2.0f, -11.0f);

	//Decoration
	BuildRenderItems("Diamond", 2.0f, 2.0f, 2.0f, 0.0f, 10.0f, 0.0f);

	//Chains for bridge
	BuildRenderItems("Wedge", 6.0f, 5.0f, 0.5f, 11.0f, 0.5f, -3.0f);
	BuildRenderItems("Wedge", 6.0f, 5.0f, 0.5f, 11.0f, 0.5f, 3.0f);

	//Walls
	BuildRenderItems("Box", 2.0f, 6.0f, 12.0f, -8.0f, 1.0f, 0.0f);
	BuildRenderItems("Box", 2.0f, 6.0f, -12.0f, 8.0f, 1.0f, 0.0f);
	BuildRenderItems("Box", 12.0f, 6.0f, 2.0f, 0.0f, 1.0f, 8.0f);
	BuildRenderItems("Box", 12.0f, 6.0f, 2.0f, 0.0f, 1.0f, -8.0f);

	//Towers
	BuildRenderItems("Cylinder", 2.0f, 8.0f, 2.0f, -8.0f, 2.0f, 8.0f);
	BuildRenderItems("Cylinder", 2.0f, 8.0f, 2.0f, 8.0f, 2.0f, 8.0f);
	BuildRenderItems("Cylinder", 2.0f, 8.0f, 2.0f, -8.0f, 2.0f, -8.0f);
	BuildRenderItems("Cylinder", 2.0f, 8.0f, 2.0f, 8.0f, 2.0f, -8.0f);

	//Tower roofs
	BuildRenderItems("Cone2", 2.0f, 8.0f, 2.0f, -8.0f, 8.0f, 8.0f);
	BuildRenderItems("Cone2", 2.0f, 8.0f, 2.0f, 8.0f, 8.0f, 8.0f);
	BuildRenderItems("Cone2", 2.0f, 8.0f, 2.0f, -8.0f, 8.0f, -8.0f);
	BuildRenderItems("Cone2", 2.0f, 8.0f, 2.0f, 8.0f, 8.0f, -8.0f);

	//Tower balls
	BuildRenderItems("Sphere", 1.0f, 1.0f, 1.0f, -8.0f, 12.0f, 8.0f);
	BuildRenderItems("Sphere", 1.0f, 1.0f, 1.0f, 8.0f, 12.0f, 8.0f);
	BuildRenderItems("Sphere", 1.0f, 1.0f, 1.0f, -8.0f, 12.0f, -8.0f);
	BuildRenderItems("Sphere", 1.0f, 1.0f, 1.0f, 8.0f, 12.0f, -8.0f);

	//Gate and door
	BuildRenderItems("Box2", 6.0f, 0.5f, 6.0f, 11.0f, -2.0f, 0.0f);
	BuildRenderItems("Box3", 0.5f, 6.0f, 6.0f, 8.0f, 1.0f, 0.0f);

	//Decoration on walls
	BuildRenderItems("Pyramid", 1.0f, 1.0f, 1.0f, -8.0f, 4.0f, 0.0f);
	BuildRenderItems("Pyramid", 1.0f, 1.0f, 1.0f, -8.0f, 4.0f, 4.0f);
	BuildRenderItems("Pyramid", 1.0f, 1.0f, 1.0f, -8.0f, 4.0f, -4.0f);

	BuildRenderItems("Pyramid", 1.0f, 1.0f, 1.0f, 0.0f, 4.0f, 8.0f);
	BuildRenderItems("Pyramid", 1.0f, 1.0f, 1.0f, 4.0f, 4.0f, 8.0f);
	BuildRenderItems("Pyramid", 1.0f, 1.0f, 1.0f, -4.0f, 4.0f, 8.0f);
	...
	BuildRenderItems("Grid", 25.0f, 20.0f, 5.0f, 0.0f, -2.0f, 0.0f);
	BuildRenderItems("Grid2", 40.0f, 20.0f, 10.0f, 0.0f, -2.8f, 0.0f);
	BuildRenderItems("Grid3", 15.0f, 20.0f, 4.0f, 0.0f, -1.8f, 0.0f);
	...
	/*BuildRootSignature();
	BuildShapeGeometry("Box2");
	BuildRenderItems("Box2", 2.0f, 2.0f, 2.0f, 5.0f, 0.0f, 0.0f);
	BuildFrameResources();
	BuildDescriptorHeaps();
	BuildConstantBufferViews();
	BuildPSOs();*/
...
//step16
void ShapesApp::BuildShapeGeometry(string name, const GeometryGenerator::MeshData& shape, XMFLOAT4 color)
{
...
void ShapesApp::BuildRenderItems(string name, float sX, float sY, float sZ, float tX, float tY, float tZ)
{
	auto boxRitem = std::make_unique<RenderItem>();
	XMStoreFloat4x4(&boxRitem->World, XMMatrixScaling(sX, sY, sZ) * XMMatrixTranslation(tX, tY, tZ));
	boxRitem->ObjCBIndex = static_cast<UINT>(mAllRitems.size()); //**** Replaced = 0
